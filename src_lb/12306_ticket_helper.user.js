...
function injectDom() {
	...
	html.push('<p>您好，12306 订票助手（淘宝专版）是专门为猎豹浏览器定制的一款免费扩展，不需要注册即可使用。但因为作者投入了很大的时间和精力，因此如果您愿意捐助，那么捐助后在此依然可以注册，注册将会将授权信息更改为您的个人信息。非常感谢您的支持！</p>');
	...
	html.push('<p> 12306 订票助手(猎豹浏览器专版) 是基于『12306订票助手』并特别为猎豹浏览器定制的订票辅助工具。<strong>本软件免费开源，无需付费使用，仅接受捐助。</strong> </p>');
	...
	if (result.result == 0) {
		...
		info.eq(0).html(result.name || "猎豹浏览器用户");
...
function initLogin() {
	...
	var info = [];
	info.push("已许可于：" + (utility.regInfo.name || "猎豹浏览器用户"));
